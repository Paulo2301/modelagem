...
public class ModelagemApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Estado estado1= new Estado(null,"Piaui");
		...
		Cidade cidade3= new Cidade(null,"Parnaiba", estado2);
		
		estado1.getCidade().addAll(Arrays.asList(cidade2, cidade3));
		estado2.getCidade().addAll(Arrays.asList(cidade1));
